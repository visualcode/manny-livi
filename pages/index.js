...
export default function IndexPage() {
  return (
    <main className="container mx-auto pl-32 pr-32 grid xs:grid-cols-[14rem_minmax(14rem,_1fr)] gap-x-32 gap-y-12">
      <div id="portrait-pic" className="w-56 h-56 bg-white">
        <img src="" alt="" />
      </div>
      ...
      <section id="hero-info" className="row-start-2 col-start-2 flex flex-col">
        ...
        <p className="text-bodySmall leading-8 tracking-5 text-primary-l dark:text-primary-d">I’m currently UI lead for the awarded <a href="https://www.8x8.com/products/contact-center/agent-workspace?locale=uk">8x8 Agent Workspace</a>, and I collaborate on the 8x8 Oxygen design system.</p>
      </section>
    </main>
  );
}
