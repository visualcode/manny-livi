      ...
      >
        <header>
          <motion.h1
            ...
            className="font-bold text-primary dark:text-primary-d xxs:text-displaySmall xxs:leading-2 xxs:tracking-3 xs:text-displayMedium xs:tracking-1 xs:leading-0 md:text-displayLarge md:leading-0 md:tracking-1 lg:text-displayXLarge lg:leading-3 lg:tracking-0 xxl:text-displayXLarge"
          >
      ...
      >
        <header>
          <motion.h2
            ...
            className="text-primary dark:text-primary-d xxs:text-introSmall xxs:leading-6 xxs:tracking-8 lg:text-introMedium lg:leading-5 lg:tracking-8"
          >
        ...
        <motion.p
          ...
          className="text-primary xxs:text-bodySmall xxs:leading-9 xxs:tracking-6 dark:text-primary-d lg:text-bodyLarge"
        >
